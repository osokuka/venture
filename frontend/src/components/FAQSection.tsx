...
export function FAQSection() {
  const faqs = [
    {
      question: "How does VentureUP Link's matching system work?",
    ...
    {
      question: "What types of investors are active on VentureUP Link?",
    ...
    {
      question: "What kind of support does VentureUP Link provide?",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Get answers to common questions about VentureUP Link and how our platform works.
          </p>
        </div>
